...
input string InpSymbols = "EURUSD,GBPUSD,USDJPY,USDCHF,USDCAD,AUDUSD,NZDUSD,EURGBP,EURJPY,EURCHF,EURCAD,EURAUD,EURNZD,GBPJPY,GBPCHF,GBPCAD,GBPAUD,GBPNZD,CHFJPY,CADJPY,AUDJPY,NZDJPY,CADCHF,AUDCHF,NZDCHF,AUDCAD,NZDCAD,AUDNZD,XAUUSD"; // 目標商品清單（逗號分隔）
